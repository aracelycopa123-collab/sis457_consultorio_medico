...
namespace Sis457ConsultorioMedico.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(FinalConsultorioMedicoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string? returnUrl = null)
        {
            ...
            var usuario = _context.Usuarios.Include(e => e.IdDoctorNavigation)
            ...
            if (usuario != null)
            {
                ...
                var claims = new List<Claim>
                {
                    ...
                    new Claim("FullName", $"{usuario.IdDoctorNavigation.Nombres} {usuario.IdDoctorNavigation.PrimerApellido} {usuario.IdDoctorNavigation.SegundoApellido}"),
